...
function View() {
  ...
  return (
    <>
      <h1>JBrowse 2 React App Demo (with rsbuild)</h1>
      <JBrowseApp viewState={viewState} />
      <h3>Code</h3>
      <p>
        The code for this app is available at{' '}
        <a
          href="https://github.com/GMOD/jbrowse-react-app-rsbuild-demo"
          target="_blank"
          rel="noreferrer"
        >
          https://github.com/GMOD/jbrowse-react-app-rsbuild-demo
        </a>
        .
      </p>
